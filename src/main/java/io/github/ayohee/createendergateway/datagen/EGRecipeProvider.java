...
import io.github.ayohee.createendergateway.datagen.recipes.*;
...
public class EGRecipeProvider extends RecipeProvider {
    ...
    public static void registerAllProcessing(DataGenerator gen, PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        ...
        GENERATORS.add(new EGFillingRecipeGen(output, registries));

        gen.addProvider(true, new DataProvider() {
            @Override
            public @NotNull String getName() {
                return "Create: Ender Gateway's Processing Recipes";
            }
            @Override
